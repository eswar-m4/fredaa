...
function AnySite() {
  ...
  return (
    <AppLayout>
      <PageHeader
        title={`${ds ? catLabel(ds.category) : cat !== "All" ? catLabel(cat) : "Solutions"} — Dataset Setup`}
        subtitle={
          ds
            ? `${ds.name} · ${ds.tagline} — choose your sources or upload your own data, then select your datapoints.`
            : "Pick a dataset, choose your sources or upload your own data, then select your datapoints. A workflow runs behind the scenes."
        }
        actions={
