...
/**
 * Zero-dependency Node.js static file server for the fredaa frontend.
...
const PORT = parseInt(process.env.PORT || '8130', 10);
...
if (!STATIC_DIR) {
  console.error(
    '[fredaa-frontend] ERROR: No built frontend found.\n' +
      'Run the following inside the frontend folder first:\n' +
...
server.listen(PORT, HOST, () => {
  ...
  console.log(`[fredaa-frontend] serving    → ${STATIC_DIR}`);
});
